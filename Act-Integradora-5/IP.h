...
//Conversión no será necesaria ya que todo se pasará a string
...
//DESCOMENTARIZAR E IMPLEMENTAR DE SER POSIBLE LOGRARLO YA QUE CON DICHAS FUNCIONES SE REMIEVE EL PUERTO Y LOS DOS PUNTOS de cada una de las direcciones IP  
 ...
 */
//Para remover dichos valores se cambiaran en Edge para ser leídas sin el puerto
//Y guardadas como string 
struct IP{
    string ip;
    int count;
    IP();
